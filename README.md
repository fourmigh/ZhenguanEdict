...
| 时期 | Agent数 | 协作模式                | 对应循环模式              | 核心创新       |
|------|---------|-------------------------|---------------------------|----------------|
| 炎黄 | 2       | 部落联盟，二人分工      | 基础单 Agent 循环          | 角色分化雏形   |
...
| 文档                           | 说明                                              |
|--------------------------------|---------------------------------------------------|
| `docs/架构设计.md`             | 整体架构、三层设计、运行时切换、模型类型定义      |
| `docs/朝代拓扑.md`             | 10 个朝代的 Agent 拓扑、角色定义、权限矩阵        |
| `docs/内建循环.md`             | 内建循环、古代制度映射、实现策略 |
